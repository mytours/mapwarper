...
ActiveRecord::Schema[8.0].define(version: 2025_10_02_021229) do
  ...
  create_table "imports_layers", force: :cascade do |t|
    t.integer "import_id"
    t.integer "layer_id"
    t.index ["import_id"], name: "index_imports_layers_on_import_id"
    t.index ["layer_id"], name: "index_imports_layers_on_layer_id"
  end
