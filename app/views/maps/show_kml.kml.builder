...
wms_baseurl = "#{request.scheme}://" + request.host_with_port + url_for(controller: 'maps', action: 'wms',
                                                                        id: @map)
this_baseurl = "#{request.scheme}://" + request.host_with_port + url_for(controller: 'maps', action: 'show',
                                                                         id: @map, format: 'kml')
xml.instruct! :xml
